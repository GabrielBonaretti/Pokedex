...
public class Pokeframe1 extends JFrame {
    ...
    public static void pegarStatus(Integer id) {
        ...
        try (BufferedReader br = new BufferedReader(new InputStreamReader(new FileInputStream(Pokeframe1.class.getResource("status/" +id+ ".txt").getFile()), "Cp1250"))) {
            String line = null;
    ...
    public static void updateIcon() {
        ImageIcon imageIcon = new ImageIcon(Pokeframe1.class.getResource(  "pokemons/" + count +  ".png" ));

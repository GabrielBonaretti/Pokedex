...
public class Pokeframe2 extends JFrame {
    ...
    public void modify(Integer value) {
        ...
        if (value < 0) {
            if (!(count + value < 0)) {
            	...
            	try {
                    AudioInputStream audioInputStream = AudioSystem.getAudioInputStream(new File("pokesom/152.wav").getAbsoluteFile());
    ...
    public static void pegarStatus(Integer id) {
        ...
        try (BufferedReader br = new BufferedReader(new InputStreamReader(new FileInputStream(Pokeframe2.class.getResource("status/" +id+ ".txt").getFile()), "Cp1250"))) {
            String line = null;
    ...
    public static void updateIcon() {
        ImageIcon imageIcon = new ImageIcon(Pokeframe2.class.getResource(  "pokemons/" + count +  ".png" ));
